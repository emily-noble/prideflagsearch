...
def index(request):
    ...
    for i in range(0, flagCount):
        ...
        for sourceIndex in range(0, sourceCount):
            sourceData["flags"][i]["citation"]["sourceList"][
                sourceIndex
            ] = createCitationStructure(
                sourceData["flags"][i]["citation"]["sourceList"][sourceIndex]
            )

        sourceData["flags"][i]["citation"]["imageSource"] = createCitationStructure(
            sourceData["flags"][i]["citation"]["imageSource"]
        )
        sourceData["flags"][i]["citation"]["firstAuthoring"] = createCitationStructure(
            sourceData["flags"][i]["citation"]["firstAuthoring"]
        )
...
def getColorFilters():
    return [
        {"value": "red", "fill": "red", "label": "Red"},
        {"value": "orange", "fill": "orange", "label": "Orange"},
        {"value": "yellow", "fill": "yellow", "label": "Yellow"},
        {"value": "green", "fill": "green", "label": "Green"},
        {"value": "blue", "fill": "blue", "label": "Blue"},
        {"value": "purple", "fill": "purple", "label": "Purple"},
        {"value": "pink", "fill": "pink", "label": "Pink"},
        {"value": "black", "fill": "black", "label": "Black"},
        {"value": "grey", "fill": "grey", "label": "Grey"},
        {"value": "white", "fill": "white", "label": "White"},
        {"value": "brown", "fill": "brown", "label": "Brown"},
        {"value": "tan", "fill": "tan", "label": "Tan"},
    ]


def createCitationStructure(rawCitation):
    if False == rawCitation:
        return {"type": "simple", "value": "Unknown"}
    ...
    if thisCitationParts is None or 4 != len(thisCitationParts.groups()):
        citationStructure = {"type": "simple", "value": rawCitation}
